...
impl RateLimiter {
    ...
    pub(crate) fn format_cookie_reply<'a>(
        ...
        #[cfg(feature = "amneziawg")]
        let cookie_reply_type = amnezia
            .map(|cfg| cfg.h3.min)
            .unwrap_or(super::COOKIE_REPLY);
        #[cfg(not(feature = "amneziawg"))]
        let cookie_reply_type = super::COOKIE_REPLY;
        message_type.copy_from_slice(&cookie_reply_type.to_le_bytes());
    ...
    pub fn verify_packet<'a, 'b>(
        ...
        let packet = Tunn::parse_incoming_packet_with_amnezia(
            src,
            #[cfg(feature = "amneziawg")]
            amnezia,
            #[cfg(not(feature = "amneziawg"))]
