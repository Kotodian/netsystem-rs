...
pub enum SessionQueueError {
    ...
    SessionAppAlreadyInstalled { app: u32 },
    #[error("Session App {app:?} is not installed on this worker")]
    SessionAppNotInstalled { app: u32 },
}
