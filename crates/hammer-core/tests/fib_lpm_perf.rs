...
//!
//! ```text
//! cargo test -p hammer-core --release --test fib_lpm_perf -- --ignored --nocapture
//! ```
//!
...
use hammer_core::forwarding::{Ip4Mtrie, Ip4MtrieRoute};
use ipnet::Ipv4Net;
...
#[test]
#[ignore = "performance probe; run with `cargo test -p hammer-core --release --test fib_lpm_perf -- --ignored --nocapture`"]
