...
use hammer_infra::mtrie::PackedMtrieValue;
...
fn adjacency_set_path_mtu_matches_vpp_adj_nbr_set_mtu() {
    use hammer_plugin_ip::forwarding::Adjacency;
...
fn ipv4_mtu_check_matches_vpp_ip4_mtu_check() {
    use hammer_plugin_ip::protocol::ip::{Ipv4MtuAction, ipv4_mtu_check};
...
fn dpo_load_balance_carries_typed_load_balance_index() {
    let load_balance = hammer_plugin_ip::forwarding::LoadBalanceIndex::new(5);
