...
pub trait Router: Lifecycle {
    ...
    fn match_route(&self, metadata: &mut RouteMetadata) -> Result<RouteDecision, CoreError>;
    fn prepare_route_metadata(&self, metadata: &mut RouteMetadata) -> Result<(), CoreError>;
